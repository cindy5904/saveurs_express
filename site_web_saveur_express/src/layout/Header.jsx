    ...
    <header id="Header">
      <div className="header-left">
        <div className="logo-container-header">
          <img className="logo-header" src={logo} alt="logo saveurs express" onClick={() => navigate("/")} />
          <div className="icon-container-header" onClick={() => navigate("/menu")}>
            <svg
      ...
      <div className="header-right">
        <div className="icon-container-header">
          <div className="count-header"  onClick={() => navigate("/commande")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
        ...
        <div className="icon-container-header" onClick={()=>navigate("/espace-client")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
